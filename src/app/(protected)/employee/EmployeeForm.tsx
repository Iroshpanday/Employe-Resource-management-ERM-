    ...
    const fetchData = async () => {
      try {
        const [branchesRes, departmentsRes] = await Promise.all([
          fetch("/api/branch", { credentials: "include" }),
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 p-4 border rounded-lg shadow">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input id="firstName" type="text" {...register("firstName")} className="border rounded px-2 py-1 w-full" />
          ...
          <div>
            ...
            <input id="lastName" type="text" {...register("lastName")} className="border rounded px-2 py-1 w-full" />
          ...
          <div>
            ...
            <input id="email" type="email" {...register("email")} className="border rounded px-2 py-1 w-full" />
          ...
          <div>
            ...
            <input id="phone" type="text" {...register("phone")} className="border rounded px-2 py-1 w-full" />
          </div>
          ...
          <div>
            ...
            <input id="position" type="text" {...register("position")} className="border rounded px-2 py-1 w-full" />
          ...
          <div>
            ...
            <select id="branchId" {...register("branchId", { valueAsNumber: true })} className="border rounded px-2 py-1 w-full">
          ...
          <div className="md:col-span-2">
            ...
            {cvFile && (
              <p className="text-sm text-green-600 mt-1">
                CV uploaded:{" "}
                <a href={cvFile} target="_blank" rel="noopener noreferrer" className="underline">
                  View
                </a>
              </p>
            )}
          ...
          <div>
            ...
            <select id="gender" {...register("gender")} className="border rounded px-2 py-1 w-full">
          ...
          <div>
            ...
            <select id="status" {...register("status")} className="border rounded px-2 py-1 w-full">
          ...
          <div className="md:col-span-2">
            ...
            <input id="address" type="text" {...register("address")} className="border rounded px-2 py-1 w-full" />
          </div>
        </div>
